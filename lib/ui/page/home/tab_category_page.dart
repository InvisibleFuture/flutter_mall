...
class _TabCategoryPageState extends State<TabCategoryPage> {
              ...
              return RefreshConfiguration(
                child: SmartRefresher(
                    ...
                    child: Container(
                      ...
                      new Expanded(
                        flex: 8,
                        child: _tabCategoryViewModel.childCategories.length == 0 ? EmptyDataView() : _childCategoryWidget(_tabCategoryViewModel),
                      ),
                    ]))),
              );
            },
          ...
          child: Row(
            children: <Widget>[
              Offstage(
                ...
                child: Container(
                  margin: EdgeInsets.only(top: ScreenUtil().setHeight(AppDimens.DIMENS_30), bottom: ScreenUtil().setHeight(AppDimens.DIMENS_30)),
              ...
              Container(
                ...
                child: Text(
                  categoryEntity.name,
                  style: selectIndex == index ? FMTextStyle.color_ff5722_size_42 : FMTextStyle.color_333333_size_42,
                ),
              )
            ],
          )),
  ...
  Widget _childCategoryWidget(TabCategoryViewModel tabCategoryViewModel) {
    return Selector<TabCategoryViewModel, List<CategoryEntity>>(builder: (BuildContext context, List<CategoryEntity> data, Widget child) {
      return SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(top: ScreenUtil().setHeight(AppDimens.DIMENS_30)),
            ),
          ],
        ),
      );
